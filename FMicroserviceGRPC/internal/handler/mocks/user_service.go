...
func (_m *UserService) Delete(ctx context.Context, login string) error {
...
func (_m *UserService) GetByLogin(ctx context.Context, login string) (*model.User, error) {
	ret := _m.Called(ctx, login)
...
func (_m *UserService) Login(ctx context.Context, login string, password string) (string, string, error) {
...
func (_m *UserService) Refresh(ctx context.Context, login string, userRefreshToken string) (string, string, error) {
...
func (_m *UserService) Signup(ctx context.Context, user *model.User) (string, string, *model.User, error) {
...
func (_m *UserService) Update(ctx context.Context, login string, user *model.User) error {
