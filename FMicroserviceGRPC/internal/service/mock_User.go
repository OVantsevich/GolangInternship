...
func (_m *MockUser) CreateUser(ctx context.Context, user *model.User) (*model.User, error) {
...
func (_m *MockUser) DeleteUser(ctx context.Context, login string) error {
...
func (_m *MockUser) GetUserByLogin(ctx context.Context, login string) (*model.User, error) {
	ret := _m.Called(ctx, login)
...
func (_m *MockUser) RefreshUser(ctx context.Context, login string, token string) error {
...
func (_m *MockUser) UpdateUser(ctx context.Context, login string, user *model.User) error {
